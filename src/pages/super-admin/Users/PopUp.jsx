    ...
    if (formType == "edit") {
      const fetchUserDetailsAndRestaurants = async () => {
        try {
          ...
          console.error("Error fetching user or restaurants:", error);
          toast.error("Failed to load user/restaurant data.");
        }
      };
      fetchUserDetailsAndRestaurants();
    }
    // Call the async function
  }, [form.user_email]); // Add form.user_email as a dependency if it can change
